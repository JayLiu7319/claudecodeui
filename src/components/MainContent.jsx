          ...
          <div className="text-center text-gray-500 dark:text-gray-400 max-w-md mx-auto px-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                💡 <strong>{t('common.tip')}:</strong> {isMobile ? t('mainContent.tipMobile') : t('mainContent.tipDesktop')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between relative">
                ...
                {activeTab === 'chat' && selectedSession ? (
                  <div className="min-w-0">
                    <h2 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white whitespace-nowrap overflow-x-auto scrollbar-hide">
                      {selectedSession.__provider === 'cursor' ? (selectedSession.name || t('mainContent.untitledSession')) : (selectedSession.summary || t('mainContent.newSession'))}
                    </h2>
                  ...
                  <div className="min-w-0">
                    <h2 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white">
                      {activeTab === 'files' ? t('mainContent.projectFiles') :
                        activeTab === 'git' ? t('mainContent.sourceControl') :
                          (activeTab === 'tasks' && shouldShowTasksTab) ? t('mainContent.taskMaster') :
                            'Project'}
                    </h2>
                    <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                      {selectedProject.displayName}
          ...
          <div className="flex-shrink-0 hidden sm:block">
            <div className="relative flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
              <Tooltip content={t('mainContent.chat')} position="bottom">
                <button
                ...
                >
                  <span className="flex items-center gap-1 sm:gap-1.5">
                    ...
                    <span className="hidden md:hidden lg:inline">{t('mainContent.chat')}</span>
                  </span>
                </button>
              </Tooltip>
              <Tooltip content={t('mainContent.shell')} position="bottom">
                <button
                ...
                >
                  <span className="flex items-center gap-1 sm:gap-1.5">
                    ...
                    <span className="hidden md:hidden lg:inline">{t('mainContent.shell')}</span>
                  </span>
                </button>
              </Tooltip>
              <Tooltip content={t('fileTree.title')} position="bottom">
                <button
                ...
                >
                  <span className="flex items-center gap-1 sm:gap-1.5">
                    ...
                    <span className="hidden md:hidden lg:inline">{t('fileTree.title')}</span>
                  </span>
                </button>
              </Tooltip>
              <Tooltip content={t('mainContent.sourceControl')} position="bottom">
                <button
                ...
                >
                  <span className="flex items-center gap-1 sm:gap-1.5">
                    ...
                    <span className="hidden md:hidden lg:inline">{t('mainContent.sourceControl')}</span>
                  </span>
                </button>
              </Tooltip>
              {shouldShowTasksTab && (
                <Tooltip content={t('tasks.title')} position="bottom">
                  <button
                  ...
                  >
                    <span className="flex items-center gap-1 sm:gap-1.5">
                      ...
                      <span className="hidden md:hidden lg:inline">{t('tasks.title')}</span>
                    </span>
                  </button>
                </Tooltip>
              )}
