                      ...
                      <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {t('settings.appearance.lineNumbersDescription')}
                            </div>
                          </div>
                          <button
                ...
                <div className="border-b border-gray-300 dark:border-gray-600">
                  <div className="flex gap-4">
                    <button
                      ...
                      className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${toolsProvider === 'claude'
                        ? 'border-blue-600 text-blue-600 dark:text-blue-400'
                        : 'border-transparent text-muted-foreground hover:text-foreground'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${toolsProvider === 'cursor'
                  ...
                  <div className="space-y-6 md:space-y-8">
                        ...
                        <label className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium text-orange-900 dark:text-orange-100">
                              {t('settings.tools.skipPermissionsWarning')}
                            </div>
                            <div className="text-sm text-orange-700 dark:text-orange-300">
                              {t('settings.tools.skipPermissionsHint')}
                            </div>
                          </div>
                        </label>
                      </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <div className="font-medium text-blue-900 dark:text-blue-100">
                                {t('settings.tools.cliLogin', { provider: 'Claude' })}
                              </div>
                              <div className="text-sm text-blue-700 dark:text-blue-300">
                                {claudeAuthStatus.authenticated
                                  ? t('settings.tools.reAuthOrSwitch')
                                  : t('settings.tools.signInToEnable', { provider: 'Claude' })}
                              </div>
                            </div>
                            <Button
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {t('settings.tools.allowedToolsDescription')}
                      </p>
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                          {t('settings.tools.quickAddCommonTools')}
                        </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {t('settings.tools.disallowedToolsDescription')}
                      </p>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                      <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">
                        {t('settings.tools.toolPatternExamples')}
                      </h4>
                      <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git log:*)"</code> - {t('settings.tools.toolPatternGitLog')}</li>
                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git diff:*)"</code> - {t('settings.tools.toolPatternGitDiff')}</li>
                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Write"</code> - {t('settings.tools.toolPatternWrite')}</li>
                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Read"</code> - {t('settings.tools.toolPatternRead')}</li>
                        <li><code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(rm:*)"</code> - {t('settings.tools.toolPatternRm')}</li>
                      </ul>
                    </div>
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                ...
                                <div className="text-sm text-muted-foreground space-y-1">
                                  ...
                                  {server.raw && (
                                    <details className="mt-2">
                                      <summary className="cursor-pointer text-xs text-muted-foreground hover:text-foreground">{t('settings.mcp.viewFullConfig')}</summary>
                                ...
                                {mcpTestResults[server.id] && (
                                  <div className={`mt-2 p-2 rounded text-xs ${mcpTestResults[server.id].success
                                ...
                                {mcpServerTools[server.id] && (
                                  <div className="mt-2 p-2 rounded text-xs bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-200 border border-blue-200 dark:border-blue-800">
                                    <div className="font-medium mb-2">{t('settings.mcp.availableToolsResources')}</div>

                                    {mcpServerTools[server.id].tools && mcpServerTools[server.id].tools.length > 0 && (
                                      <div className="mb-2">
                                        <div className="font-medium text-xs mb-1">{t('settings.mcp.tools')} ({mcpServerTools[server.id].tools.length}):</div>
                                    ...
                                    {mcpServerTools[server.id].resources && mcpServerTools[server.id].resources.length > 0 && (
                                      <div className="mb-2">
                                        <div className="font-medium text-xs mb-1">{t('settings.mcp.resources')} ({mcpServerTools[server.id].resources.length}):</div>
                                        <ul className="space-y-0.5">
                                    ...
                                    {mcpServerTools[server.id].prompts && mcpServerTools[server.id].prompts.length > 0 && (
                                      <div>
                                        <div className="font-medium text-xs mb-1">{t('settings.mcp.prompts')} ({mcpServerTools[server.id].prompts.length}):</div>
                                        <ul className="space-y-0.5">
                                    ...
                                    {(!mcpServerTools[server.id].tools || mcpServerTools[server.id].tools.length === 0) &&
                                      (!mcpServerTools[server.id].resources || mcpServerTools[server.id].resources.length === 0) &&
                                      (!mcpServerTools[server.id].prompts || mcpServerTools[server.id].prompts.length === 0) && (
                                        <div className="text-xs opacity-75">{t('settings.mcp.noToolsDiscovered')}</div>
                                      )}
                                  </div>
                                )}
                              </div>
                      ...
                      <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[110] p-4">
                        <div className="bg-background border border-border rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                          <div className="flex items-center justify-between p-4 border-b border-border">
                            <h3 className="text-lg font-medium text-foreground">
                              {editingMcpServer ? t('settings.mcp.editServer') : t('settings.mcp.addServer')}
                            </h3>
                          ...
                          <form onSubmit={handleMcpSubmit} className="p-4 space-y-4">
                            ...
                            {mcpFormData.importMode === 'form' && editingMcpServer && (
                              <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                <label className="block text-sm font-medium text-foreground mb-2">
                                  {t('settings.mcp.scope')}
                                </label>
                                <div className="flex items-center gap-2">
                                  {mcpFormData.scope === 'user' ? <Globe className="w-4 h-4" /> : <FolderOpen className="w-4 h-4" />}
                                  <span className="text-sm">
                                    {mcpFormData.scope === 'user' ? t('settings.mcp.scopeUser') : t('settings.mcp.scopeLocal')}
                                  </span>
                                ...
                                <p className="text-xs text-muted-foreground mt-2">
                                  {t('settings.mcp.scopeCannotChange')}
                                </p>
                              </div>
                            )}
                              ...
                              <div className="space-y-4">
                                  ...
                                  <div className="flex gap-2">
                                    ...
                                    >
                                      <div className="flex items-center justify-center gap-2">
                                        ...
                                        <span>{t('settings.mcp.scopeUser')}</span>
                                      </div>
                                    </button>
                                    <button
                                      type="button"
                                    ...
                                    >
                                      <div className="flex items-center justify-center gap-2">
                                        ...
                                        <span>{t('settings.mcp.scopeLocal')}</span>
                                      </div>
                                    </button>
                                  </div>
                                  <p className="text-xs text-muted-foreground mt-2">
                                    {mcpFormData.scope === 'user'
                                      ? t('settings.mcp.scopeUserDesc')
                                      : t('settings.mcp.scopeLocalDesc')
                                    }
                                  </p>
                                </div>
                                ...
                                {mcpFormData.scope === 'local' && !editingMcpServer && (
                                  <div>
                                    ...
                                    >
                                      <option value="">{t('settings.mcp.selectProject')}</option>
                                    ...
                                    {mcpFormData.projectPath && (
                                      <p className="text-xs text-muted-foreground mt-1">
                                        {t('settings.mcp.path')}: {mcpFormData.projectPath}
                                      </p>
                                    )}
                                  </div>
                                )}
                            ...
                            {mcpFormData.importMode === 'json' && (
                              <div className="space-y-4">
                                <div>
                                  <label className="block text-sm font-medium text-foreground mb-2">
                                    {t('settings.mcp.jsonConfiguration')} *
                                  </label>
                                  <textarea
                            ...
                            {mcpFormData.importMode === 'form' && (
                              <div>
                                <label className="block text-sm font-medium text-foreground mb-2">
                                  {t('settings.mcp.environmentHint')}
                                </label>
                                <textarea
                            ...
                            <div className="flex justify-end gap-2 pt-4">
                              ...
                              >
                                {mcpLoading ? t('settings.mcp.saving') : (editingMcpServer ? t('settings.mcp.updateServer') : t('settings.mcp.addServer'))}
                              </Button>
                            </div>
                          </form>
                        </div>
                  ...
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <AlertTriangle className="w-5 h-5 text-orange-500" />
                        <h3 className="text-lg font-medium text-foreground">
                          {t('settings.cursor.permissionSettings')}
                        </h3>
                      </div>
                      <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                        <label className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-orange-700 dark:text-orange-300">
                              {t('settings.cursor.skipPermissionsHint')}
                            </div>
                          </div>
                        </label>
                      </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <div className="font-medium text-purple-900 dark:text-purple-100">
                                {t('settings.tools.cliLogin', { provider: 'Cursor' })}
                              </div>
                              <div className="text-sm text-purple-700 dark:text-purple-300">
                                {cursorAuthStatus.authenticated
                                  ? t('settings.tools.reAuthOrSwitch')
                                  : t('settings.tools.signInToEnable', { provider: 'Cursor' })}
                              </div>
                            </div>
                            <Button
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <Shield className="w-5 h-5 text-green-500" />
                        <h3 className="text-lg font-medium text-foreground">
                          {t('settings.cursor.allowedShellCommands')}
                        </h3>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        {t('settings.cursor.allowedShellCommandsDesc')}
                      </p>
                      ...
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                          {t('settings.cursor.quickAddCommonCommands')}
                        </p>
                        <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-lg font-medium text-foreground">
                          {t('settings.cursor.disallowedShellCommands')}
                        </h3>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        {t('settings.cursor.disallowedShellCommandsDesc')}
                      </p>
                    ...
                    <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-purple-800 dark:text-purple-200 space-y-1">
                        <li><code className="bg-purple-100 dark:bg-purple-800 px-1 rounded">"Shell(ls)"</code> - {t('settings.cursor.commandExampleLs')}</li>
                        <li><code className="bg-purple-100 dark:bg-purple-800 px-1 rounded">"Shell(git status)"</code> - {t('settings.cursor.commandExampleGitStatus')}</li>
                        <li><code className="bg-purple-100 dark:bg-purple-800 px-1 rounded">"Shell(mkdir)"</code> - {t('settings.cursor.commandExampleMkdir')}</li>
                        <li><code className="bg-purple-100 dark:bg-purple-800 px-1 rounded">"-f"</code> flag - {t('settings.cursor.commandExampleFlag')}</li>
                      </ul>
                    </div>
                  </div>
                )}
