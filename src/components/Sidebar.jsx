...
const formatTimeAgo = (dateString, currentTime) => {
  ...
  // Note: Time formatting is handled with i18n in the component
  if (diffInSeconds < 60) return { key: 'common.justNow' };
  if (diffInMinutes === 1) return { key: 'common.minAgo', count: 1 };
  if (diffInMinutes < 60) return { key: 'common.minsAgo', count: diffInMinutes };
  if (diffInHours === 1) return { key: 'common.hourAgo' };
  if (diffInHours < 24) return { key: 'common.hoursAgo', count: diffInHours };
  if (diffInDays === 1) return { key: 'common.dayAgo' };
  if (diffInDays < 7) return { key: 'common.daysAgo', count: diffInDays };
          ...
          <div className="md:space-y-1 pb-safe-area-inset-bottom">
            {isLoading ? (
              <div className="text-center py-12 md:py-8 px-4">
                ...
                <h3 className="text-base font-medium text-foreground mb-2 md:mb-1">{t('sidebar.loadingProjects')}</h3>
                <p className="text-sm text-muted-foreground">
                  {t('sidebar.fetchingProjects')}
                </p>
              </div>
            ) : projects.length === 0 ? (
              <div className="text-center py-12 md:py-8 px-4">
              ...
              <div className="text-center py-12 md:py-8 px-4">
                ...
                <h3 className="text-base font-medium text-foreground mb-2 md:mb-1">{t('sidebar.noMatchingProjects')}</h3>
                <p className="text-sm text-muted-foreground">
                  {t('sidebar.noMatchingHint')}
                </p>
              </div>
            ) : (
