      ...
      {isCheckingInstallation ? (
        <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">{t('settings.tasksConfig.checkingInstallation')}</span>
          </div>
        </div>
      ) : (
        <>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="font-medium text-orange-900 dark:text-orange-100 mb-2">
                    {t('settings.tasksConfig.notInstalledTitle')}
                  </div>
                  <div className="text-sm text-orange-800 dark:text-orange-200 space-y-3">
                    <p>{t('settings.tasksConfig.notInstalledDesc')}</p>
                    ...
                    <div>
                      ...
                      >
                        ...
                        {t('settings.tasksConfig.viewOnGithub')}
                    ...
                    <div className="space-y-2">
                      <p className="font-medium">{t('settings.tasksConfig.afterInstallation')}</p>
                      <ol className="list-decimal list-inside space-y-1 text-xs">
                        <li>{t('settings.tasksConfig.restartApp')}</li>
                        <li>{t('settings.tasksConfig.featuresAvailable')}</li>
                        <li>{t('settings.tasksConfig.useInitCommand')} <code className="bg-orange-100 dark:bg-orange-800 px-1 rounded">task-master init</code> {t('settings.tasksConfig.inProjectDirectory')}</li>
                      </ol>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-foreground">
                      {t('settings.tasksConfig.enableIntegration')}
                    </div>
                    <div className="text-sm text-muted-foreground mt-1">
                      {t('settings.tasksConfig.enableIntegrationDesc')}
                    </div>
                  </div>
